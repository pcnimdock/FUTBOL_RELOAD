...
void MainWindow::on_btn_procesar_clicked()
{
    ...
    {
        QString file_path=ui->lineEdit->text()+"/EQ959900.DBC";
    ...
    foreach (eq_file_str, lista_archivos) {
        ...
        file_path = ui->lineEdit->text() + "/" + eq_file_str;
        ...
        QString path_minifoto_eq=ui->lineEdit->text() + "/MINIESC/" +
        ...
        QString path_bigfoto_eq=ui->lineEdit->text() + "/BIGESC/" +
                QString("EQ%1.DFG").arg(QString::number(equipo.EquipoIdDBC),6,QChar('0'));
        ...
        path_esc_sim.remove("DBDAT",Qt::CaseInsensitive);
        ...
        while(isEntrenador)
        {
            ...
            QString path_minifoto_entr=ui->lineEdit->text() + "/MINIENTR/" +
            ...
            QString path_bigfoto_entr=ui->lineEdit->text() + "/BIGENTR/" +
                    QString("E95%1.DFG").arg(QString::number(entrenador.puntero),5,QChar('0'));
        ...
        while(isJugador)
        {
            ...
            QString path_minifoto=ui->lineEdit->text() + "/" + QString("MINIFOTO/J95%1.DFG").arg(QString::number(jugador.puntero),5,QChar('0'));
            ...
            QString path_bigfoto=ui->lineEdit->text() + "/BIGFOTO/" +
